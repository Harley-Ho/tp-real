<?php
    ...
    $tab_avg=get_avg_stats();
    $avg=$tab_avg['moyenne_general'];
?>
<html>
    <head>
        <meta charset="utf-8">
    ...
    <table class="table">
        ...
        <tbody>
            <tr>
                ...
                <td><?= $row['nb_femmes'] ?></td>
                <td><?= $row['nb_total'] ?></td>
                <?php $color=$avg>$row['salaire_moyen']?"red":"green";?>
                <td style="color: <?php echo $color; ?>;"><?= number_format($row['salaire_moyen'], 0, ',', ' ') ?> €</td>
            </tr>
        </tbody>
        <?php } ?>
    </table>
